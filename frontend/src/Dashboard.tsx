  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <main style={{ marginLeft: 220, flex: 1, padding: '48px 32px' }} className="dashboard-main">
        ...
        <div style={{ width: '100%', maxWidth: '100vw', margin: '0 -32px' }}>
          <DashboardAnalytics analytics={analytics} loading={loading} />
        </div>
        <SkillPieChart analytics={analytics} loading={loading} />
